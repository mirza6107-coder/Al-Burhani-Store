...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.querySelectorAll(".btn-card, .btn-main").forEach((btn) => {
    btn.addEventListener("click", (e) => {
      // Only count "SHOP NOW" card buttons, not hero CTA
      if (btn.classList.contains("btn-card")) {
        e.preventDefault();
        cartCount++;
        if (cartBadge) {
  ...
  const announcements = [
    ...
    "New Arrivals — Premium Apparel Collections Now Live",
    "✦ 100% Authentic Luxury Couture ✦",
