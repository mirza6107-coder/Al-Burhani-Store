...
<head>
  ...
  <title>Al Burhan Store — Exclusive Apparel</title>
...
<body>
  ...
  <header>
    ...
    <ul class="nav-links">
      ...
      <li><a href="../Dress/dress.php" class="nav-active">Dress</a></li>
  ...
  <section class="hero">
    ...
    <div class="hero-content">
      <div class="hero-tag">
        ...
        <span>WEAR THE SPOTLIGHT</span>
        <span class="tag-line"></span>
      </div>
      <h2 class="hero-title">
        <span class="title-main">FASHION THAT</span>
        <span class="title-accent">OWNS THE ROOM</span>
      </h2>
      <p class="hero-desc">
        Step into luxury outfits crafted to elevate your presence,<br>confidence, and signature style.
      </p>
  ...
  <div class="marquee-strip">
    <div class="marquee-track">
      <span>COUTURE CRAFTSMANSHIP</span><span class="marquee-gem">✦</span>
      <span>LUXURY FABRICS</span><span class="marquee-gem">✦</span>
      <span>REFINED SILHOUETTES</span><span class="marquee-gem">✦</span>
      <span>EXCLUSIVE DESIGNS</span><span class="marquee-gem">✦</span>
    </div>
  </div>

  <!-- PRODUCTS SECTION -->
  <section id="collection" style="padding: 100px 40px 80px;">
    <div class="section-header">
      ...
      <h2 class="section-title">All Dress Products</h2>
      <p class="section-subtitle"><?= count($db_products) ?> exquisite pieces available</p>
    </div>
      ...
      <?php foreach ($db_products as $p): ?>
        <div class="card">
          <div class="card-img-wrap">
            ...
            <?php else: ?>
              <div style="height:100%;display:flex;align-items:center;justify-content:center;background:rgba(212,175,55,.06);font-size:60px;color:rgba(212,175,55,.2)">
          ...
          <div class="card-body">
            ...
            <p class="card-desc"><?= htmlspecialchars($p['description'] ?: 'Premium luxury dress') ?></p>

            <div style="color:#d4af37;font-size:17px;font-family:'Cinzel',serif;margin:10px 0 16px;">
  ...
  <section class="trust-section">
    <div class="trust-grid">
      <div class="trust-item">
        ...
        <div>
          <h5>100% Authentic</h5>
          <p>Every piece guaranteed genuine</p>
        </div>
      </div>
