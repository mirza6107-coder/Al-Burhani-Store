...
<head>
  ...
  <title>Al Burhan Store — Perfumes</title>
...
<body>
  ...
  <div class="announcement-bar">
    ...
    <span>Premium Fragrance Collections Now Available</span>
  ...
  <header>
    ...
    <ul class="nav-links">
      ...
      <li><a href="../Perfumes/Perfumes.php" class="nav-active">Perfumes</a></li>
  ...
  <section class="hero">
    ...
    <div class="hero-content">
      ...
      <h2 class="hero-title">
        <span class="title-main">THE ART OF</span>
        <span class="title-accent">FRAGRANCE</span>
      </h2>
      <p class="hero-desc">
        Rare oud, amber &amp; floral compositions crafted<br>for those who demand the extraordinary.
      </p>
  ...
  <div class="marquee-strip">
    <div class="marquee-track">
      <span>OUD &amp; AMBER</span><span class="marquee-gem">✦</span>
      <span>FLORAL BOUQUETS</span><span class="marquee-gem">✦</span>
      <span>WOODY ELEGANCE</span><span class="marquee-gem">✦</span>
      <span>ORIENTAL BLENDS</span><span class="marquee-gem">✦</span>
      <span>FRESH AQUATICS</span><span class="marquee-gem">✦</span>
      <span>OUD &amp; AMBER</span><span class="marquee-gem">✦</span>
      <span>FLORAL BOUQUETS</span><span class="marquee-gem">✦</span>
      <span>WOODY ELEGANCE</span><span class="marquee-gem">✦</span>
      <span>ORIENTAL BLENDS</span><span class="marquee-gem">✦</span>
  ...
  <?php if (!empty($db_products)): ?>
    <section id="collection" style="padding:0 0 80px;">
      <div class="section-header" style="padding-top:0;">
        ...
        <p class="section-subtitle"><?= count($db_products) ?> premium fragrances available</p>
      </div>
        ...
        <?php foreach ($db_products as $p): ?>
          <div class="card" style="--delay:0s">
            <div class="card-img-wrap">
              ...
              <?php else: ?>
                <div style="height:220px;display:flex;align-items:center;justify-content:center;background:rgba(212,175,55,.06);font-size:40px;color:rgba(212,175,55,.3)">
            ...
            <div class="card-body">
              ...
              <p class="card-desc"><?= htmlspecialchars($p['description'] ?: 'Premium luxury fragrance') ?></p>
  ...
  <section class="trust-section">
    <div class="trust-grid">
      <div class="trust-item">
        ...
        <div>
          <h5>100% Authentic</h5>
          <p>Every bottle guaranteed genuine</p>
        </div>
      </div>
