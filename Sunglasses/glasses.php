...
<head>
  ...
  <title>Al Burhan Store — Premium Sunglasses</title>
...
<body>
  ...
  <div class="announcement-bar">
    ...
    <span>Premium Eyewear Collections Now Available</span>
  ...
  <header>
    ...
    <ul class="nav-links">
      ...
      <li><a href="../Sunglasses/glasses.php" class="nav-active">Sunglasses</a></li>
  ...
  <section class="hero">
    ...
    <div class="hero-content">
      <div class="hero-tag">
        ...
        <span>VISION MEETS LUXURY</span>
        <span class="tag-line"></span>
      </div>
      <h2 class="hero-title">
        <span class="title-main">FRAMES THAT</span>
        <span class="title-accent">DEFINE YOU</span>
      </h2>
      <p class="hero-desc">
        Explore luxury sunglasses crafted for bold style,<br>sharp looks, and unmatched confidence.
      </p>
  ...
  <div class="marquee-strip">
    <div class="marquee-track">
      <span>AVIATOR FRAMES</span><span class="marquee-gem">✦</span>
      <span>LUXURY ACETATE</span><span class="marquee-gem">✦</span>
      <span>POLARISED LENSES</span><span class="marquee-gem">✦</span>
      <span>DESIGNER EYEWEAR</span><span class="marquee-gem">✦</span>
      <span>AVIATOR FRAMES</span><span class="marquee-gem">✦</span>
      <span>LUXURY ACETATE</span><span class="marquee-gem">✦</span>
      <span>POLARISED LENSES</span><span class="marquee-gem">✦</span>
      <span>DESIGNER EYEWEAR</span><span class="marquee-gem">✦</span>
  ...
  <?php if (!empty($db_products)): ?>
    <section style="padding:0 0 80px;">
      <div class="section-header" style="padding-top:0;">
        ...
        <h2 class="section-title">All Sunglasses Products</h2>
        ...
        <?php foreach ($db_products as $p): ?>
          <div class="card" style="--delay:0s">
            <div class="card-img-wrap">
              ...
              <?php else: ?>
                <div style="height:220px;display:flex;align-items:center;justify-content:center;background:rgba(212,175,55,.06);font-size:40px;color:rgba(212,175,55,.3)"><i class="fas fa-glasses"></i></div>
              <?php endif; ?>
  ...
  <section class="trust-section">
    <div class="trust-grid">
      <div class="trust-item">
        ...
        <div>
          <h5>100% Authentic</h5>
          <p>Every frame guaranteed genuine</p>
        </div>
      </div>
